...
namespace WallGrowth {
 ...
 //reserve begin
    ...
    // { // growth based on predefined field principal vector  
    //   // stored at index 0  and two principal values at indices 3 and 7  in the cell vector
    ...
    //           double 
    //             factor1=parameter(0)*h*(growthVal1-strainThreshold);
    //           double 
    //             factor2=parameter(0)*h*(growthVal2-strainThreshold);
