...
///
/// @details A constant force, F, is applied axially to regions in z between z_0 + a and z_0+a+d(upward force) and
/// z_0 -a and -a-d(downward) resembling forces generated by internal tissues in e.g.
