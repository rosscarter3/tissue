...
int VolumeViaLongestWallCenterTriangulation::flag(
...
void VolumeViaLongestWallCenterTriangulation::update(
    Tissue *T, size_t i, DataMatrix &cellData, DataMatrix &wallData,
...
int VolumeViaLongestWall3DCenterTriangulation::flag(
    Tissue *T, size_t i, DataMatrix &cellData, DataMatrix &wallData,
    DataMatrix &vertexData, DataMatrix &cellDerivs, DataMatrix &wallDerivs,
    DataMatrix &vertexDerivs) {
  if (T->cell(i).calculateVolume(vertexData) > parameter(0)) {
...
void VolumeViaLongestWall3DCenterTriangulation::update(
    Tissue *T, size_t i, DataMatrix &cellData, DataMatrix &wallData,
    DataMatrix &vertexData, DataMatrix &cellDeriv, DataMatrix &wallDeriv,
    DataMatrix &vertexDeriv) {
  Cell *divCell = &(T->cell(i));
  ...
  if (flag != 1) {
    std::cerr
        << "divideVolumeViaLongestWall3DCenterTriangulation::update() Warning"
...
VolumeViaLongestWallSpatial::VolumeViaLongestWallSpatial(
    std::vector<double> &paraValue,
    std::vector<std::vector<size_t>> &indValue) {
  //
  // Do some checks on the parameters and variable indeces
...
int VolumeViaLongestWallSpatial::flag(Tissue *T, size_t i, DataMatrix &cellData,
                                      DataMatrix &wallData,
...
void VolumeViaLongestWallSpatial::update(
    Tissue *T, size_t i, DataMatrix &cellData, DataMatrix &wallData,
    DataMatrix &vertexData, DataMatrix &cellDeriv, DataMatrix &wallDeriv,
    DataMatrix &vertexDeriv) {
  Cell *divCell = &(T->cell(i));
...
VolumeViaLongestWall3D::VolumeViaLongestWall3D(
    std::vector<double> &paraValue,
    std::vector<std::vector<size_t>> &indValue) {
  // Do some checks on the parameters and variable indeces
  //////////////////////////////////////////////////////////////////////
...
/*!
 */
int VolumeViaLongestWall3D::flag(Tissue *T, size_t i, DataMatrix &cellData,
                                 DataMatrix &wallData, DataMatrix &vertexData,
                                 DataMatrix &cellDerivs, DataMatrix &wallDerivs,
                                 DataMatrix &vertexDerivs) {
  if (T->cell(i).calculateVolume(vertexData) > parameter(0)) {
...
/*!
 */
void VolumeViaLongestWall3D::update(Tissue *T, size_t i, DataMatrix &cellData,
                                    DataMatrix &wallData,
                                    DataMatrix &vertexData,
...
/*!
 */
int VolumeViaDirection::flag(Tissue *T, size_t i, DataMatrix &cellData,
                             DataMatrix &wallData, DataMatrix &vertexData,
                             DataMatrix &cellDerivs, DataMatrix &wallDerivs,
                             DataMatrix &vertexDerivs) {
  if (T->cell(i).calculateVolume(vertexData) > parameter(0)) {
...
//! Updates the dividing cell by adding a prependicular wall from the defined
//! direction
/*!
 */
void VolumeViaDirection::update(Tissue *T, size_t cellI, DataMatrix &cellData,
                                DataMatrix &wallData, DataMatrix &vertexData,
                                DataMatrix &cellDeriv, DataMatrix &wallDeriv,
                                DataMatrix &vertexDeriv) {
  Cell *divCell = &(T->cell(cellI));
...
VolumeRandomDirection::VolumeRandomDirection(
    std::vector<double> &paraValue,
    std::vector<std::vector<size_t>> &indValue) {
  // Do some checks on the parameters and variable indeces
  //
...
int VolumeRandomDirection::flag(Tissue *T, size_t i, DataMatrix &cellData,
                                DataMatrix &wallData, DataMatrix &vertexData,
                                DataMatrix &cellDerivs, DataMatrix &wallDerivs,
                                DataMatrix &vertexDerivs) {
  if (T->cell(i).calculateVolume(vertexData) > parameter(0)) {
...
void VolumeRandomDirection::update(Tissue *T, size_t cellI,
...
int VolumeViaShortestPath::flag(Tissue *T, size_t i, DataMatrix &cellData,
                                DataMatrix &wallData, DataMatrix &vertexData,
                                DataMatrix &cellDerivs, DataMatrix &wallDerivs,
                                DataMatrix &vertexDerivs) {
  if (T->cell(i).calculateVolume(vertexData) > parameter(0)) {
...
void VolumeViaShortestPath::update(Tissue *T, size_t i, DataMatrix &cellData,
                                   DataMatrix &wallData, DataMatrix &vertexData,
                                   DataMatrix &cellDeriv, DataMatrix &wallDeriv,
                                   DataMatrix &vertexDeriv) {
  Cell *divCell = &(T->cell(i));
...
ShortestPath::ShortestPath(std::vector<double> &paraValue,
  ...
  if (paraValue.size() != 4 && paraValue.size() != 6) {
    std::cerr
        << "DivisionShortestPath::DivisionShortestPath() "
...
int ShortestPath::flag(Tissue *T, size_t i, DataMatrix &cellData,
                       DataMatrix &wallData, DataMatrix &vertexData,
                       DataMatrix &cellDerivs, DataMatrix &wallDerivs,
                       DataMatrix &vertexDerivs) {
  if (T->cell(i).calculateVolume(vertexData) > parameter(0)) {
...
void ShortestPath::update(Tissue *T, size_t i, DataMatrix &cellData,
                          DataMatrix &wallData, DataMatrix &vertexData,
                          DataMatrix &cellDerivs, DataMatrix &wallDerivs,
                          DataMatrix &vertexDerivs) {
  Cell &cell = T->cell(i);
  ...
  if (vertexData[0].size() == 3) {
    ...
    for (size_t k = 0; k < 3; ++k)
      if (normW != 0)
        ...
        std::cerr << " in DivisionShortestPath first wall vector is wrong"
                  << std::endl;
        exit(0);
      }
    ...
    for (size_t k = 0; k < 3; ++k)
      if (normW != 0)
        ...
        std::cerr << " in DivisionShortestPath second wall vector is wrong"
                  << std::endl;
        exit(0);
      }
...
std::vector<ShortestPath::Candidate> ShortestPath::getCandidates(
    Tissue *T, size_t i, DataMatrix &cellData, DataMatrix &wallData,
    DataMatrix &vertexData, DataMatrix &cellDerivs, DataMatrix &wallDerivs,
    DataMatrix &vertexDerivs) {
  Cell cell = T->cell(i);
...
void MainAxis::update(Tissue *T, size_t cellI, DataMatrix &cellData,
  ...
  if (candidates.size() > 2) {
    std::cerr << "DivisionMainAxis: Warning, more than two candidates could be "
                 "found.\n";
  }
