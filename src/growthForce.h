...
/// or more abtractly to generate specific shapes (e.g. by generating forces moving vertices on
/// on a surface of a specific shape). These reactions are typically then combine with
