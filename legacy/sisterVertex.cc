...
void SpringCellConc::
    ...
    for (size_t i = 0; i < N; ++i) {
        ...
        size_t cell1 = T.vertex(T.sisterVertex(i, 0)).cell(0) != T.background() ? T.vertex(T.sisterVertex(i, 0)).cell(0)->index() : T.vertex(T.sisterVertex(i, 0)).cell(1)->index();
        size_t cell2 = T.vertex(T.sisterVertex(i, 1)).cell(0) != T.background() ? T.vertex(T.sisterVertex(i, 1)).cell(0)->index() : T.vertex(T.sisterVertex(i, 1)).cell(1)->index();
