...
///
/// @brief Reactions describing degradation of molecules.
///
/// @details A compilation of reactions implementing degradation of molecules
///
namespace Degradation {
  ...
  ///
  /// @details The variable update is for each cell is given by 
  ...
  /// In a model file the reaction is defined as
  /// @verbatim
  /// Degradation::N 1 2 1 N
  /// k_c
  /// c_index
  /// X_0 .. X_n
  /// @endverbatim
  ///
  class N : public BaseReaction {  
  public:      
    ///
    /// @brief Main constructor
    ///
  ...
  ///
  /// @details The update to the variable is
  ...
  /// where @f$p_0@f$ is the degradation rate (@f$d@f$), and @f$p_1@f$ is the Hill
  ...
  /// @endverbatim
  ///
  class HillN : public BaseReaction {
  public:
    ///
    /// @brief Main constructor
    ///
    ...
    /// @see BaseReaction::createReaction(std::vector<double> &paraValue,...)
    ///
    HillN(std::vector<double> &paraValue, 
	  std::vector< std::vector<size_t> > &indValue );
    ///
    /// @brief Derivative function for this reaction class
    ///
  ...
  /// In a model file the reaction is defined as
  /// @verbatim
  /// Degradation::TwoGeometric 1 2 1 1
  /// k_c
  /// c_index
  /// X_index
  /// @endverbatim
  ///
  class TwoGeometric : public BaseReaction {
  public:
    ///
    /// @brief Main constructor
    ///
  ...
  ///
  /// @details The variable update is for each boundary cell given by 
  /// @f[ \frac{dc}{dt} = - k_c c@f]
  /// where @f$ k_c @f$ is a constant parameter and @f$ c @f$ is the (mulecular) cell variable/concentration
  ...
  /// In a model file the reaction is defined as
  /// @verbatim
  /// Degradation::OneBoundary 1 1 1
  /// k_c
  /// c_index
  /// @endverbatim
  ///
  class OneBoundary : public BaseReaction {
  public:
    ///
    /// @brief Main constructor
    ///
  ...
  /// In a model file the reaction is defined as
  /// @verbatim
  /// Degradation::OneFromList 1 2 1 N
  /// k_c
  /// c_index
  /// cell_index_0 .. cell_index_N
  /// @endverbatim
  ///
  class OneFromList : public BaseReaction {
  private:
    size_t numCellI;
  public:
    ///
